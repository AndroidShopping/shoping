...
public class SearchBleAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String dName = bluetoothDevice.getName() == null ? comm.shop.shopping.utils.TextUtils.getString(R.string.unkonw_device) : bluetoothDevice.getName();
        if (TextUtils.isEmpty(dName)) {
            dName = comm.shop.shopping.utils.TextUtils.getString(R.string.unkonw_device);
        }
        holder.name.setText(dName);
        String dAddress = bluetoothDevice.getAddress() == null ? comm.shop.shopping.utils.TextUtils.getString(R.string.unkonw_address) : bluetoothDevice.getAddress();
        if (TextUtils.isEmpty(dAddress)) {
            dAddress = comm.shop.shopping.utils.TextUtils.getString(R.string.unkonw_address);
        }
