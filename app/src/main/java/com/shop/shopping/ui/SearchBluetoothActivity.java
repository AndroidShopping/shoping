...
public class SearchBluetoothActivity extends BluetoothActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    private void init() {
        if (!BtUtil.isOpen(bluetoothAdapter)) {
            ...
            if (!PrintUtil.isBondPrinter(this, bluetoothAdapter)) {
                ...
                //已绑定蓝牙设备
                tv_title.setText(getPrinterName() + com.shop.shopping.utils.TextUtils.getString(R.string.connected));
                String blueAddress = PrintUtil.getDefaultBluethoothDeviceAddress(this);
                if (TextUtils.isEmpty(blueAddress)) {
                    blueAddress = com.shop.shopping.utils.TextUtils.getString(R.string.search_bluetooth);
                }
    ...
    public void btFoundDevice(Intent intent) {
        ...
        if (null != bluetoothAdapter && device != null) {
            ...
            String dName = device.getName() == null ? com.shop.shopping.utils.TextUtils.getString(R.string.unkonw_device) : device.getName();
        }
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        new AlertDialog.Builder(this)
                .setTitle(com.shop.shopping.utils.TextUtils.getString(R.string.bind) + getPrinterName(bluetoothDevice.getName()) + "?")
